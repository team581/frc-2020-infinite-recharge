...
public class Autonomous {
  ...
  public static final double getDriveCommand(final double initalEncoderValue, final double distanceToDrive) {
    ...
    encoderDistance = (currentEncoderValue - initalEncoderValue) / Constants.Autonomous.Movement.INCHES_PER_ROTATION;
  ...
  public static final boolean isFinished() {
    /**
     * Checks if the distance to the desired encoder value is within a margin of
     * error
     */
